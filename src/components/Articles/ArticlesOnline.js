...
const ArticlesOnline = ({articles}) => {
   // varible localStorage vers view/article in buutton "voir"
   var viewArt ;
  ...
  return (
                <div className="container  my-10 border">
                    ...
                    <div className="leading-9 text-green-600 border-b border-gray-100 mb-2 pb-3  bg-gray-300 text-2xl py-15 px-5 ">
                        <h2  className="font-bold"> Produits en ligne</h2>
                    </div>

                    <div class="relative overflow-x-auto shadow-md sm:rounded-lg">
                       <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                           <thead class="text-xs text-gray-700 uppercase bg-gray-50 dark:bg-green-500 dark:text-gray-100">
                              <tr>
...

                              {
                                articles.map((article)=>{
                                  return(
                                    <tr className="bg-gray-100 hover:bg-gray-200 border-t border-b">
                                        <th scope="col" class="p-4">
                                            <div class="flex items-center">
                                        ...
                                        <th scope="col" class="px-6 py-3 ">{article.description}</th>
                                        <th scope="col" class="px-6 py-3">
                                           <button onClick={Navigue} type="button" className="bg-gray-800  text-gray-100 py-2 px-2  rounded-lg"> voir </button>
                                        </th>
                                    </tr>
                                  )
                                })
