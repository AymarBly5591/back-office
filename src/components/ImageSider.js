  ...
  return (
    ...
    <div className="w-full">
            ...
            <div className="sliderAx h-4/5">
                <div id="slider-1" className="mx-auto">
                    <div className="bg-cover bg-center  h-auto text-white py-24 px-10 object-fill" style={{backgroundImage: "url('https://images.unsplash.com/photo-1544427920-c49ccfb85579?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=1422&q=80')"}}>
                        ...
                        <a href="http://tradydaddy.com/"  className="bg-purple-800 py-4 px-8 text-white font-bold uppercase text-xs rounded hover:bg-gray-200 hover:text-gray-800">Contact us</a>
                        </div>  
                    </div> 
                    <br/>
                </div>
        ...
        <div className="container mx-auto">
            <h1 className="text-center text-black-800 py-6 text-5xl ">
                Services
            </h1> 
            <div className="text-gray-900">
                <div className="grid grid-cols-6 mb-20">
                    <div className="col-span-1 text-center text-6xl py-4"><i className="fa fa-gift" aria-hidden="true"></i></div>
        ...
        <div className="bg-purple-600">
            <div className="container mx-auto">
                <div className="flex py-16 items-center ">
                    <div className="text-white bg-purple-700 rounded-2xl shadow-lg px-20 py-4 mx-2 text-xl">All </div>
                    <div className="text-purple-700  bg-white rounded-2xl shadow-lg px-20 py-4 mx-2 text-xl">Graphic</div>
                    <div className="text-purple-700  bg-white rounded-2xl shadow-lg px-20 py-4 mx-2 text-xl">UI/UX</div>
                    <div className="text-purple-700  bg-white rounded-2xl shadow-lg px-20 py-4 mx-2 text-xl">Branding</div>
                </div>
            </div>
        ...
        <div className="grid grid-cols-4 p-8">
            <div className="col-span-1 py-6">
                <div className="relative">
                    <a href="http://tradydaddy.com/" >
                    
                        <img src="https://picsum.photos/id/200/400/400" alt="" className="rounded-2xl relative"/>                     
                        <div className="absolute bottom-0 left-0 text-xl p-4 w-full text-white font-bold"><p>Absolute child</p></div>
            ...
            <div className="col-span-1 py-6">
                <div className="relative">
                    <a href="http://tradydaddy.com/" >
                        ...
                        <img src="https://picsum.photos/id/201/400/400" alt="" className="rounded-2xl relative"/>                     
                        <div className="absolute bottom-0 left-0 text-xl p-4 w-full text-white font-bold"><p>Absolute child</p></div>
            ...
            <div className="col-span-1 py-6">
                <div className="relative">
                    <a href="http://tradydaddy.com/" >
                        ...
                        <img src="https://picsum.photos/id/202/400/400" alt="" className="rounded-2xl relative"/>                     
                        <div className="absolute bottom-0 left-0 text-xl p-4 w-full text-white font-bold"><p>Absolute child</p></div>
            ...
            <div className="col-span-1 py-6">
                <div className="relative">
                    <a href="http://tradydaddy.com/" >
                        ...
                        <img src="https://picsum.photos/id/203/400/400" alt="" className="rounded-2xl relative"/>                     
                        <div className="absolute bottom-0 left-0 text-xl p-4 w-full text-white font-bold"><p>Absolute child</p></div>
            ...
            <div className="col-span-1 py-6">
                <div className="relative">
                    <a href="http://tradydaddy.com/" >
                        ...
                        <img src="https://picsum.photos/id/204/400/400" alt="" className="rounded-2xl relative"/>                     
                        <div className="absolute bottom-0 left-0 text-xl p-4 w-full text-white font-bold"><p>Absolute child</p></div>
            ...
            <div className="col-span-1 py-6">
                <div className="relative">
                    <a href="http://tradydaddy.com/" >
                        ...
                        <img src="https://picsum.photos/id/208/400/400" alt="" className="rounded-2xl relative"/>                     
                        <div className="absolute bottom-0 left-0 text-xl p-4 w-full text-white font-bold"><p>Absolute child</p></div>
            ...
            <div className="col-span-1 py-6">
                <div className="relative">
                    <a href="http://tradydaddy.com/" >
                        ...
                        <img src="https://picsum.photos/id/206/400/400" alt="" className="rounded-2xl relative"/>                     
                        <div className="absolute bottom-0 left-0 text-xl p-4 w-full text-white font-bold"><p>Absolute child</p></div>
            ...
            <div className="col-span-1 py-6">
                <div className="relative">
                    <a href="http://tradydaddy.com/" >
                        ...
                        <img src="https://picsum.photos/id/209/400/400" alt="" className="rounded-2xl relative"/>                     
                        <div className="absolute bottom-0 left-0 text-xl p-4 w-full text-white font-bold"><p>Absolute child</p></div>
